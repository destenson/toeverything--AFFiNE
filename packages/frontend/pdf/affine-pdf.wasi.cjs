...
const __wasmDebugFilePath = __nodePath.join(__dirname, 'affine-pdf.wasm32-wasi.debug.wasm')
...
if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  ...
  try {
    ...
    throw new Error('Cannot find affine-pdf.wasm32-wasi.wasm file, and @affine/pdf-wasm32-wasi package is not installed.')
  }
}
